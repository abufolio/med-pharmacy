...
const scan_card_dto_1 = require("./dto/scan-card.dto");
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CardsController.prototype, "findByUid", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)('SUPER_ADMIN', 'PHARMACY_ADMIN'),
    ...
    __metadata("design:returntype", Promise)
], CardsController.prototype, "updateStatus", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)('SUPER_ADMIN', 'PHARMACY_ADMIN'),
    ...
    __metadata("design:returntype", Promise)
], CardsController.prototype, "assignCard", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)('SUPER_ADMIN', 'PHARMACY_ADMIN'),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [assign_card_dto_1.UnassignCardDto]),
    __metadata("design:returntype", Promise)
], CardsController.prototype, "unassignCard", null);
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [scan_card_dto_1.ScanCardDto]),
    __metadata("design:returntype", Promise)
], CardsController.prototype, "scan", null);
